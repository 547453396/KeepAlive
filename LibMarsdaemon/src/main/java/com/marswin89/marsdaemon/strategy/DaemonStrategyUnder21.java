		...
		Thread t = new Thread(){
			public void run() {
				...
				try {
					...
					//java.lang.UnsatisfiedLinkError: Native method not found: com.marswin89.marsdaemon.nativ.NativeDaemonAPI20.doDaemon:(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
